...
echo Disable password expiration, then set new password (optional).
...
REM https://www.isumsoft.com/windows-10/how-to-disable-password-expiration-in-windows-10.html
